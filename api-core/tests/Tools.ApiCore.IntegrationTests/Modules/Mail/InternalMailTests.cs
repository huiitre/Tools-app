...
namespace Tools.ApiCore.IntegrationTests.Modules.Mail;
...
public sealed class InternalMailTests : IClassFixture<ApiCoreWebApplicationFactory>
{
    private readonly ApiCoreWebApplicationFactory factory;

    public InternalMailTests(ApiCoreWebApplicationFactory factory)
    {
