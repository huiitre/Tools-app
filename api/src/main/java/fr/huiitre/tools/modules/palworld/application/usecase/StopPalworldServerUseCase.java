...
@Service
public class StopPalworldServerUseCase implements SecuredUseCase {

    private final PalworldServerPort palworldServerPort;

    public StopPalworldServerUseCase(PalworldServerPort palworldServerPort) {
