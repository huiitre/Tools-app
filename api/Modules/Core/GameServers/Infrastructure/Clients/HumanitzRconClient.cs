...
public sealed partial class HumanitzRconClient
{
    ...
    public async Task<GameServerStatus> FetchStatusAsync(GameServerTarget gameServer, CancellationToken cancellationToken)
    {
        try
        {
            var password = GameServerProtocolConfig.GetString(gameServer.ProtocolConfig, "rconPassword");
            ...
            return new GameServerStatus(
                ...
                GameServerProtocolConfig.GetPositiveInt(gameServer.ProtocolConfig, "maxPlayersOverride"));
        }
