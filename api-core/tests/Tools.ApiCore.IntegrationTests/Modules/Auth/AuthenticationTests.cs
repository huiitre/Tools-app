...
public sealed class AuthenticationTests : IClassFixture<ApiCoreWebApplicationFactory>
{
    ...
    public AuthenticationTests(ApiCoreWebApplicationFactory factory)
    {
    ...
    private string ForgeAccessToken(long userId, DateTime notBefore, DateTime expires)
    {
        ...
        var signingKey = new SymmetricSecurityKey(
            Encoding.UTF8.GetBytes(ApiCoreWebApplicationFactory.TestJwtSecret));
        ...
        [
            ...
            new("userType", "HUMAN"),
            new("roles", """["READ_ONLY"]""", JsonClaimValueTypes.JsonArray),
