...
public class PalworldBreedingController {
    ...
    public PalworldBreedingController(
            GetBreedingResultUseCase getBreedingResultUseCase, GetBreedingParentsUseCase getBreedingParentsUseCase) {
    ...
    @GetMapping("/parents")
    @ResponseStatus(HttpStatus.OK)
    public List<BreedingParentPairView> getParents(@RequestParam("child") Long childId) {
