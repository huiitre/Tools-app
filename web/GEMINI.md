...
- UI : Support des retours à la ligne (white-space: pre-wrap) et suppression de la limite de lignes dans le body.
[Feature] Core/Notification — Support multi-lignes (2026-05-10) :
- UI : Support des retours à la ligne via white-space: pre-wrap.
- UI : Suppression de la limite de 2 lignes (line-clamp) pour afficher l'intégralité du message (ex: liste de skins).
