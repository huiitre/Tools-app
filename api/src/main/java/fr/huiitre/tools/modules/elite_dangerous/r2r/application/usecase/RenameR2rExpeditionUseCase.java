...
@Service
@Transactional
public class RenameR2rExpeditionUseCase implements SecuredUseCase {
    ...
    public RenameR2rExpeditionUseCase(
    ...
    public void execute(UUID id, RenameR2rExpeditionCommand command) {
        ...
        if (command.getName() == null || command.getName().isBlank()) {
            throw new IllegalArgumentException("R2R_NAME_REQUIRED");
        }

        repository.rename(id, userId, command.getName().trim());
    }
}
