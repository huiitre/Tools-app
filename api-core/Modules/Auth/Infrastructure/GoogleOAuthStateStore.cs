...
public sealed class GoogleOAuthStateStore : IGoogleOAuthStateStore
{
    ...
    public string Create(string source)
    {
        ...
        {
            throw ApplicationException.Validation("GOOGLE_SOURCE_INVALID", "Source Google invalide.");
        }
    ...
    public string Consume(string state)
    {
        ...
        {
            throw ApplicationException.Unauthorized("GOOGLE_STATE_INVALID", "Authentification Google invalide.");
        }
