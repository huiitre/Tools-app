...
| `api-java/` | l'API Spring Boot d'origine, figée et vidée module par module. Elle sert encore Dofus, Palworld et Feedback. Elite Dangerous en a été retiré le 24/08/2026 et Riot le 29/08/2026 ; leurs modules vivent désormais dans `api/`, où Temtem est né directement le 30/08/2026 sans jamais passer par elle (voir `api/docs/TEMTEM.md`). |
