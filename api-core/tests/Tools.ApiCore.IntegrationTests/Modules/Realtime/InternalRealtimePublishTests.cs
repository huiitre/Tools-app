...
namespace Tools.ApiCore.IntegrationTests.Modules.Realtime;
...
public sealed class InternalRealtimePublishTests : IClassFixture<ApiCoreWebApplicationFactory>
{
    private readonly ApiCoreWebApplicationFactory factory;

    public InternalRealtimePublishTests(ApiCoreWebApplicationFactory factory)
    {
